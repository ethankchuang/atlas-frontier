...
export type ChatMessageType = 'chat' | 'emote' | 'system' | 'room_description' | 'action_result' | 'narration' | 'item_found' | 'item_obtained' | 'duel_outcome' | 'monster_combat_outcome' | 'ai_response' | 'quest_storyline';
